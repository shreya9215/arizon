...
/**
 * @file
 * Display Suite Testimony Teaser template.
 *
 * Available variables:
 *
 * Layout:
...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> clearfix">
  ...
  <?php endif; ?>
    ...
    <<?php print $left_wrapper; ?> class="ds-left-testimony<?php print $left_classes; ?>">
      <?php print $left; ?>
    </<?php print $left_wrapper; ?>>

    <<?php print $right_wrapper; ?> class="ds-right-testimony<?php print $right_classes; ?>">
      <?php print $right; ?>
